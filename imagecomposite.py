...
class ImageLoader:
    ...
    def load_imgs(self, folder):
        print("Clearing Cache")

        self.all_files_found = False
        self.missing_entries = ["0", "1", "2", "3", "4"]
    ...
    def generate_full_ctm(self, sel_res):
        ...
        return mount_ctms(components_a, components_b, components_c, components_d, components_e)

def mount_ctms(a_list, b_list, c_list, d_list, e_list):
    a1 = a_list[0]
    a2 = a_list[1]
    a3 = a_list[2]
    a4 = a_list[3]
